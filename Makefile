...
# File:     Makefile
#
# Purpose:  Makefile for the BeamInstSupport library
#
# Author:   M. Palmer   7/8/05
#
...
#-----------------------------------------------------------------------------
LIB_SRC_DIRS  := code api
OBJ_SRC_DIRS  :=
CONFIG_DIRS   :=
LOCAL_INCS    := include ../CBPM-TSHARC/include
SRC_EXCLUDE   :=
M_FILE_LIST   := Makefile.shared Makefile.mex
